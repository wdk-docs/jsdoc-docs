...
.. rst:directive:: @implements
   ...
   :Overview:
      ...
      Add the :rst:dir:`@implements` tag to the top-level symbol that implements the
      interface (for example, a constructor function). You do not need to add
      the :rst:dir:`@implements` tag to each member of the implementation (for
   ...
   :Examples:
      ...
      .. code-block:: js
         :caption: Using the @implements tag
